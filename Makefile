...
COMPILE_SCHEME = compiler.ss test-driver.ss tests.ss blah.ss
...
ZO_FILES = $(foreach dir,lang pass,$(call zo_files,$(dir))) $(foreach file,$(COMPILE_SCHEME),$(call zo_file,$(file)))
