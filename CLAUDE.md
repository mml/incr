...
**Key insight:** If you see an error about a primitive not being implemented, grep for where it's used in the compiler passes - it might be generated by a transformation, not written by the user.
